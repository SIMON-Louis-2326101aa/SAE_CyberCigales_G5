    ...
    <div class="nav-right-side">
        <div id="nav-auth-buttons">
            ...
            if (isset($_SESSION['utilisateur'])) {
                ...
                <?php if (isset($_SESSION['email']) && $_SESSION['email'] === 'escapethecode2025@gmail.com') : ?>
                    ...
                    <a href="index.php?controller=Admin&action=listUsers" class="active btn-nav" id="admin-button">
                        Admin</a>
                <?php endif; ?>
                <?php
            } else {
                ?>
                <a href="index.php?controller=Redirection&action=openHomepage" class="active btn-nav">Accueil</a>
                <a href="index.php?controller=Redirection&action=openFormRegister" class="active btn-nav">
                    Inscription</a>
                <a href="index.php?controller=Redirection&action=openFormConnection" class="active btn-nav">
                    Connexion</a>
                <?php
            }
            ?>
        ...
        <div class="settings-menu-container">
            <button id="settings-button" class="settings-button"
                    aria-label="Ouvrir les paramètres" aria-haspopup="true" aria-expanded="false">
                ⚙️
            </button>
