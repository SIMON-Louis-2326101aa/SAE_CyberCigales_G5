...
<div class="phishing-page-container-welcome">
    ...
    <div class="phishing-trap-card">
        <h2>Vous venez d'être piégé !</h2>
        <p>En arrivant sur cette page factice de suivi de colis, un pirate aurait pu récupérer :</p>
        <ul class="phishing-trap-list">
            <li>Votre adresse IP</li>
            <li>Votre localisation</li>
            <li>Vos coordonnées bancaires (si vous aviez payé les frais de port)</li>
        </ul>
