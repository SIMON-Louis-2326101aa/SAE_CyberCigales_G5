...
<div class="colis-container" data-team="<?php echo htmlspecialchars($team); ?>">
    ...
    <div id="colis-login-card" class="colis-card">
        ...
        <form id="colis-form" onsubmit="event.preventDefault();">
            ...
            <button type="button" id="colis-fill-btn" class="colis-btn-fill"
                    onclick="autoFillColis()">Remplir les identifiants</button>
            <button type="button" id="colis-login-btn" class="colis-btn-submit hidden"
                    onclick="showWarningPhishingColis()">Se connecter</button>
        </form>
    </div>
    ...
    <div id="colis-warning-msg" class="colis-warning">
        ...
        <p>
            Ceci est une simulation de phishing très courante. Les pirates usurpent
            l'identité de <strong>La Poste</strong>
        ...
        <ul class="gen-warning-list">
            ...
            <li><strong>La demande d'argent :</strong> Un petit montant est demandé pour débloquer
                une situation crédible.</li>
            <li><strong>L'URL :</strong> Les sites officiels sont toujours en <strong>laposte.fr</strong>.</li>
        </ul>
        <p><em>Règle d'or : Ne cliquez jamais sur un lien de suivi de colis reçu par mail.
                Allez directement sur le site officiel et tapez votre numéro de suivi.</em></p>
    </div>
