...
<div class="genealogie-container" data-team="<?php echo htmlspecialchars($team); ?>">
    ...
    <div id="gen-card-box" class="genealogie-card">
        ...
        <form id="gen-form" onsubmit="event.preventDefault();">
            ...
            <button type="button" id="gen-fill-btn" class="genealogie-btn-fill" onclick="autoFillGenealogie()">Remplir le formulaire</button>
            <button type="button" id="gen-submit-btn" class="genealogie-btn-submit hidden" onclick="showWarningPhishingGenealogie()">Créer le compte</button>
        </form>
    </div>
    ...
    <div id="gen-warning-msg" class="genealogie-warning">
        ...
        <p>
            Cette page simulait une offre alléchante pour vous inciter à divulguer vos <strong>coordonnées bancaires</strong>.
        ...
        <ul class="gen-warning-list">
            ...
            <li>Le cadenas dans la barre d'adresse : est-il présent ? (mais attention, cela ne garantit pas l'honnêteté du site).</li>
            <li>La demande de paiement immédiat pour un service "gratuit" ou une "découverte".</li>
        </ul>
        <p><em>Ne transmettez jamais vos codes de carte bancaire par un lien reçu par mail sans avoir vérifié la source.</em></p>
    </div>
