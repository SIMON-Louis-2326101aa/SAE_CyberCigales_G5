...
if (isset($_SESSION['team']) && ($_SESSION['team'] === "alice")) : ?>
    <div class="intro-letter-content">
        <p>Vous incarnez le personnage d'Alice, une jeune lycéenne de 16 ans vivant aux alentours de Marseille avec
            ses parents.
            Un après-midi de fin d’hiver, vous rangez discrètement les chaussures de votre mère que vous lui avez
            empruntées sans sa permission,
            lorsque vous renversez une boîte qui s’ouvre et éparpille tous les documents sur le sol. Vous récupérez
            les documents et la boîte
            et vous vous dirigez vers votre chambre pour tout ranger correctement. Vous remarquez que les papiers
            sont très anciens et qu’il y
            a quelques photos que vous n'avez jamais vues, ainsi qu'une lettre avec un logo de papillon tenant une clé.

            En la retournant, une étrange inscription attire votre attention :</p>

        <p class="clue-letter">
            “Sache que la clé du savoir sommeille dans un empereur antique. Certains l’appelaient Caesar, d’autres
            l’appellent encore le décalage du destin.”
        </p>

        <p>L’air semble soudainement plus froid… Vous décidez d’ouvrir la lettre.</p>
    </div><br>
    ...
    <div id="letterContainer" class="letter-wrapper">
        <div id="letterContent" class="letter-content" role="button" tabindex="0" aria-pressed="false">
            ...
            <div class="letter-face letter-front">
                ...
                <p>deki qledi lk, tqdi bu huwqht tu jq vybbu qbysu, sujju cucu bkukh gku jk qlqyi
                    udvqdj subbu tu bq skhyeiyju uj tk sekhqwu cubui. du bq bqyiiu fqi i ujuydthu,
                    cucu iy bu cedtu judju tu bq seklhyh t ecrhu.</p>

                <p>jekj su gku deki qledi sedijhkyj, jekj su gku deki qledi sqsxu, deki b qledi
                    vqyj fekh gku gkubgk kd seccu ubbu fkyiiu kd zekh secfhudthu.</p>

                <p>qlus jekju bq judthuiiu gku bu ludj d q fqi ucfehjuu. jui whqdti fqhudji gky j qycudj.</p>
...
<?php elseif (isset($_SESSION['team']) && ($_SESSION['team'] === "bob")) : ?>
    <div class="intro-letter-content">
        ...
        <p>Vous incarnez le personnage de Bob, un jeune lycéen de 17 ans vivant aux alentours de Marseille avec ses
            parents.
            Un après-midi de fin d’hiver, vous êtes de corvée pour ranger les décorations de Noël au grenier.
            Lors de votre rangement, vous trébuchez sur une boîte qui se renverse et éparpille des papiers anciens et
            des photos jaunies.

            Vous la ramassez, intrigué : les visages sur les photos vous semblent familiers… mais sans savoir d'où.

            Au fond, une lettre scellée porte un logo élégant : un papillon et une clé.

            En la retournant, vous découvrez une étrange phrase :</p>
    ...
    <div id="letterContainer" class="letter-wrapper">
        <div id="letterContent" class="letter-content" role="button" tabindex="0" aria-pressed="false">
            ...
            <div class="letter-face letter-front">
                ...
                <p>sv x'i k zkc no pkedo dbyz kxmsoxxo zyeb odbo zkbnyxxoo, xs no nscdkxmo dbyz qbkxno
                    zyeb odbo pbkxmrso. zkbpysc, vk fso xyec cozkbo xyx zyeb xyec zexsb,
                    wksc zyeb xyec kzzboxnbo k bofoxsb.</p>

                <p>dyx psvc lyl zyccono notk moddo pvkwwo aeo xyec kfyxc bomyxxeo :
                    vk cysp no mywzboxnbo, n’kvvob kenovk noc ofsnoxmoc.
                    ksnovo k omyedob mo ae’yx xo nsd zkc, k vsbo mo ae’yx xo wyxdbo zvec.</p>

                <p>mo aeo xyec kfyxc vkscco nobbsobo xyec x’ocd zkc ex dbocyb n’yb ye no zsobbo,
                    wksc ex wocckqo exo zkbd no xydbo rscdysbo,
                    mkmroo nkxc voc zvsc ne dowzc.</p>

                <p>kfom v’oczysb aeo voc mrowsxc zobnec co mbyscoxd k xyefoke.
                    doc qbkxnczkboxdc aes d’kswoxd.</p>
