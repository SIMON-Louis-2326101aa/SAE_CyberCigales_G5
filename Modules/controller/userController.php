  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td align="center">
    <table width="600" style="background:#ffffff; padding:20px; border-radius:8px; box-shadow:0 4px 8px rgba(0,0,0,0.1);">
      <tr><td style="text-align:center;">
        ...
        <p style="font-size:14px; color:#888888;">Ce code expire dans 10 minutes.</p>
            ...
            if ($sent) {
                ...
                if (class_exists('Constant') && method_exists('Constant', 'isDev') && Constant::isDev()) {
                    ...
                    if (function_exists('log_console')) log_console("Register: email non envoyé (local) — code: {$code}", 'info');
                } else {
        ...
        $stored = $emailModel->storePendingRegistration($nom, $prenom, $email, password_hash($password, PASSWORD_BCRYPT));
        if (!$stored) {
...
<div style="font-family: Arial, sans-serif; padding: 20px; background-color: #f4f4f4;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td align="center">
    ...
    public function logout()
    {
        ...
        unset($_SESSION['utilisateur'], $_SESSION['user_id'], $_SESSION['nom'], $_SESSION['prenom'], $_SESSION['email']);
    ...
    <table width="600" style="background:#ffffff; padding:20px; border-radius:8px; box-shadow:0 4px 8px rgba(0,0,0,0.1);">
      <tr><td style="text-align:center;">
        ...
        <p style="margin: 20px 0;">
          <a href="' . htmlspecialchars($resetLink) . '" style="display:inline-block; padding:10px 20px; background:#007bff; color:#fff; text-decoration:none; border-radius:5px; font-weight:bold;">
